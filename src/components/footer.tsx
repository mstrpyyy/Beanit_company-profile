...
export default function Footer() {
  return (
    <div>
        <footer className="footer p-10 bg-grey3 text-base-content">
            <nav>
                <p className="footer-title text-white">Services</p> 
            ...
            <nav>
                <p className="footer-title text-white">Company</p> 
            ...
            <nav>
                <p className="footer-title text-white">Social</p> 
