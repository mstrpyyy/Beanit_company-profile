        ...
        <div className="hero bg-herobg w-screen max-md:w-full" >
          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-4xl gap-y-96">
              ...
              <Link href="#overview" className='bg-blue2 text-white font-base text-lg py-3 px-4 rounded-lg transition-colors duration-200 hover:bg-blue1'>Get to know us</Link>
            </div>
          </div>
        </div>
      </div>
