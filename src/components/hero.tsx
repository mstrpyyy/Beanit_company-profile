    ...
    <div className="w-full bg-xblack flex justify-center">
        <div className="hero bg-herobg w-screen max-md:w-full" >
          ...
          <div className="hero-content text-center text-neutral-content">
            <div data-aos="fade-up" className="max-w-4xl gap-y-96">
              ...
              <Link href="#overview" className='bg-blue1 text-white font-base text-lg py-3 px-4 rounded-lg transition-colors duration-200 hover:bg-blue2'>Get to know us <FaArrowAltCircleDown className='inline' /></Link>
            </div>
          </div>
        </div>
      </div>
