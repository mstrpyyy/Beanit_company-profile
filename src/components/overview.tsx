  ...
  return (
    ...
    <div className="flex justify-evenly gap-10 flex-wrap-reverse items-center md:w-[90vw] pt-20 px-10">
      ...
      <div className="md:flex-1 md:min-w-[500px]">
        <h1 data-aos="fade-up" className="text-4xl md:text-5xl font-bold max-md:text-center text-blue2 mb-5">Company Overview</h1>
        <p data-aos="fade-up"  className="text-xwhite leading-10 text-justify text-xl font-light">
